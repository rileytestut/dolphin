...
@property (weak, nonatomic) IBOutlet RSTSwitch* m_skip_efb_cpu_switch;
@property (weak, nonatomic) IBOutlet RSTSwitch* m_ignore_format_changes_switch;
@property (weak, nonatomic) IBOutlet RSTSwitch* m_store_efb_copies_switch;
@property (weak, nonatomic) IBOutlet RSTSwitch* m_defer_efb_copies_switch;
@property (weak, nonatomic) IBOutlet RSTSwitch* m_gpu_decoding_switch;
@property (weak, nonatomic) IBOutlet RSTSwitch* m_store_xfb_copies_switch;
@property (weak, nonatomic) IBOutlet RSTSwitch* m_immediate_xfb_switch;
@property (weak, nonatomic) IBOutlet RSTSwitch* m_fast_depth_switch;
@property (weak, nonatomic) IBOutlet RSTSwitch* m_bbox_switch;
@property (weak, nonatomic) IBOutlet RSTSwitch* m_vertex_rounding_switch;
@property (weak, nonatomic) IBOutlet RSTSwitch* m_save_texture_cache_switch;

@property (weak, nonatomic) IBOutlet RSTSlider* m_accuracy_slider;
